...
export const checkSitePin = (project, path) => {
  ...
  return (
    `Site ${m[1]} is OUTSIDE this project's pinned sites (${project.path}: ${pin.join(", ")}). ` +
    "Refusing — this usually means the command targets the wrong client. Fix the site id, or edit .wf.json if the pin itself is stale."
  );
};
