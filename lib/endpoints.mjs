...
//
// Paths beginning `/beta/` come from the BETA spec (openapi/v2-beta.yml) and
// are served from the `/beta` version root instead of `/v2` — client.mjs picks
// the base from the path. The four pages/*schema-markup* entries were added by
// hand from the published beta reference, ahead of the v2 snapshot, because the
// stable spec does not carry them yet.
...
export const ENDPOINTS = [
  ...
  {
    group: "pages",
    name: "get-schema-markup",
    method: "GET",
    path: "/beta/pages/{page_id}/schema-markup",
    summary: "Get Page Schema Markup (JSON-LD) — beta"
  },
  {
    group: "pages",
    name: "list",
  ...
  {
    group: "pages",
    name: "query-schema-markup-bulk",
    method: "POST",
    path: "/beta/sites/{site_id}/pages/schema-markup/query",
    summary: "Bulk Get Page Schema Markup (JSON-LD, up to 100 pages) — beta"
  },
  {
    group: "pages",
  ...
  {
    group: "pages",
    name: "update-schema-markup",
    method: "PUT",
    path: "/beta/pages/{page_id}/schema-markup",
    summary: "Update Page Schema Markup (JSON-LD) — beta"
  },
  {
    group: "pages",
    name: "update-schema-markup-bulk",
    method: "PATCH",
    path: "/beta/sites/{site_id}/pages/schema-markup",
    summary: "Bulk Update Page Schema Markup (JSON-LD, up to 25 pages) — beta"
  },
  {
    group: "pages",
